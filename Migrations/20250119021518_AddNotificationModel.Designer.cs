...
namespace TaskManagementAPI.Migrations
{
    ...
    [Migration("20250119021518_AddNotificationModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagement.API.Models.Project", b =>
                {
                    ...
                    b.HasIndex("ProjectManagerEmail");
            ...
            modelBuilder.Entity("TaskManagement.API.Models.UserProject", b =>
                {
                    b.Property<string>("UserEmail")
                        .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("TaskManagement.API.Models.Notification", b =>
                {
                    b.HasOne("TaskManagement.API.Models.User", "ToUser")
            ...
            modelBuilder.Entity("TaskManagement.API.Models.Project", b =>
                {
                    b.HasOne("TaskManagement.API.Models.User", "ProjectManager")
                        .WithMany("ManageProjects")
                        .HasForeignKey("ProjectManagerEmail")
                        .HasPrincipalKey("Email")
